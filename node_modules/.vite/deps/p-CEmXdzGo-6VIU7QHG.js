...
var v = async (o2, n, r, a, e2, s, d2 = false, c2 = 0, l3 = true) => {
  if (!r && !a) return;
  ...
  if (u2(o2, n, true, f3.inputSafeY, d2), D(n), s && r && (S = f3.scrollPadding, b(r, S)), "undefined" != typeof window) {
    let a2;
    const e3 = async () => {
      void 0 !== a2 && clearTimeout(a2), window.removeEventListener("ionKeyboardDidShow", d3), window.removeEventListener("ionKeyboardDidShow", e3), r && await c(r, 0, f3.scrollAmount, f3.scrollDuration), u2(o2, n, false, f3.inputSafeY), document.activeElement === n && D(n), s && y(n, r, () => S = 0);
    }, d3 = () => {
...
var x = async (t2, i3) => {
  if (void 0 === o) return;
  const l3 = "ios" === i3, f3 = "android" === i3, w2 = t2.getNumber("keyboardHeight", 290), m2 = t2.getBoolean("scrollAssist", true), b2 = t2.getBoolean("hideCaretOnScroll", l3), y2 = t2.getBoolean("inputBlurring", false), S2 = t2.getBoolean("scrollPadding", true), D2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), K = await t.getResizeMode(), g = async (n) => {
...
@ionic/core/components/p-CEmXdzGo.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=p-CEmXdzGo-6VIU7QHG.js.map
